...
class DataGenerator:
    ...
    def createKVDataSet(self, sc, dataType, records, uniqueKeys, uniqueValues, keyLength, valueLength, numPartitions, seed, persistenceType):
...
if __name__ == "__main__":
    ...
    parser.add_option("--wait-for-exit", action="store")
    ...
    spark = SparkSession.builder.appName("TestRunner").getOrCreate()
